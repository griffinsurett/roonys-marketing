const Button = ({
  ...
  const baseClasses =
    'px-12 cursor-pointer py-5 rounded-full font-black text-xl transition-all duration-300 transform hover:scale-105 flex items-center space-x-3 shadow-2xl uppercase border-4';
  const variants = {
